...
function Add({ token }) {
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col sm:flex-row gap-2 w-fll sm:gap-8">
        <div>
          <p className="mb-2">Product cateory</p>
          <select
        ...
        <div>
          <p className="mb-2">Sub cateory</p>
          <select
      ...
      <button
        type="submit"
        className="w-28 py-3 mt-4 bg-black text-white cursor-pointer  transition-transform duration-150 active:scale-95"
      >
        ADD
      </button>
    </form>
